...
describe("Layout Elements of Landing Page", () => {
  describe("Rendering", () => {
    it("should have a Navbar component with logo and 2 buttons", () => {
      ...
      expect(screen.getByTestId("logo")).toHaveTextContent("Frello");
      ...
      expect(
        screen.getByTestId("navbar_get_Frello_button")
      ).toBeInTheDocument();
      expect(screen.getByTestId("navbar_get_Frello_button")).toHaveTextContent(
        "Get Frello for free"
      );
      expect(
        screen.getByTestId("navbar_get_Frello_button").closest("a")
